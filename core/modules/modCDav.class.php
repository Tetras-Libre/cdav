 ...
 * Copyright (C) 2015      Befox SARL           <contact@befox.fr>
 *
...
/**
 * 	\defgroup   cdav     Module CDav
 *  \brief      allows caldav and carddav clients to sync with Dolibarr.
 *  \file       htdocs/cdav/core/modules/modCDav.class.php
 *  \ingroup    cdav
...
/**
 *  Description and activation class for module CDav
 */
class modCDav extends DolibarrModules
{
	...
	function __construct($db)
	{
        ...
        */
		...
		$this->menu[$r++] = array(	'fk_menu'=>'fk_mainmenu=companies,fk_leftmenu=contacts',			                // Put 0 if this is a top menu
